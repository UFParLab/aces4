...
#include "test_controller_multiple.h"
...
//TEST(BasicSial,DISABLED_DISABLED_empty0) {
...
#endif
TEST(BasicSial,DISABLED_DISABLED_helloworld) {
...
TEST(BasicSial,DISABLED_DISABLED_no_arg_user_sub) {
...
TEST(BasicSial,DISABLED_DISABLED_index_decs) {
...
TEST(BasicSial,DISABLED_DISABLED_DISABLED_pardo_loop) {
	int MAX_DIMS = 6;
...
TEST(BasicSial,DISABLED_DISABLED_DISABLED_pardo_loop_corner_case) {
	int MAX_DIMS = 6;
 ...
 */
TEST(BasicSial,DISABLED_DISABLED_DISABLED_pardo_loop_illegal_range) {
	int MAX_DIMS = 6;
...
TEST(BasicSial,DISABLED_DISABLED_DISABLED_self_multiply_test) {
...
TEST(BasicSial,DISABLED_DISABLED_DISABLED_transpose4d_tmp) {
...
TEST(BasicSial,DISABLED_DISABLED_DISABLED_transpose4d_square_tmp) {
...
//TODO  FIXTHIS
TEST(BasicSial,DISABLED_DISABLED_DISABLED_basic_assign_to_static_array_test){
