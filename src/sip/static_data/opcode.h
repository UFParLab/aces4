...
SIPOP(block_scale_op,166,"block_scale",false)\
SIPOP(block_scale_assign_op,167,"block_scale_assign",false)\
SIPOP(block_scale_accumulate_op,168,"block_scale_accumulate",false)\
SIPOP(block_accumulate_scalar_op,169,"block_accumulate_scalar",false)\
SIPOP(block_add_op,170,"block_add",false)\
SIPOP(block_subtract_op,171,"block_subtract",false)\
SIPOP(block_contract_op,172,"block_contract",false)\
SIPOP(block_contract_accumulate_op,173,"block_contract_accumulate",false)\
SIPOP(block_contract_to_scalar_op,174,"block_contract_to_scalar",false)\
SIPOP(block_load_scalar_op,175,"block_load_scalar",false)\
SIPOP(slice_op,176,"slice",false)\
SIPOP(insert_op,177,"insert",false)\
SIPOP(string_load_literal_op,178,"string_load_literal",false)\
SIPOP(print_string_op,179,"print_string",false)\
SIPOP(println_op,180,"println",false)\
SIPOP(print_index_op,181,"print_index",false)\
SIPOP(print_scalar_op,182,"print_scalar",false)\
SIPOP(print_int_op,183,"print_int",false)\
SIPOP(print_block_op,184,"print_block",false)\
SIPOP(gpu_on_op,185,"gpu_on",false)\
SIPOP(gpu_off_op,186,"gpu_off",false)\
SIPOP(gpu_allocate_op,187,"gpu_allocate",false)\
SIPOP(gpu_free_op,188,"gpu_free",false)\
SIPOP(gpu_put_op,189,"gpu_put",false)\
SIPOP(gpu_get_op,190,"gpu_get",false)\
SIPOP(gpu_get_int_op,191,"gpu_get_int",false)\
SIPOP(gpu_put_int_op,192,"gpu_put_int",false)\
SIPOP(set_persistent_op,193,"set_persistent",false)\
SIPOP(restore_persistent_op,194,"restore_persistent",false)\
SIPOP(idup_op,195,"idup",false)\
SIPOP(iswap_op,196,"iswap",false)\
SIPOP(sswap_op,197,"sswap",false)\
