...
SIPOP(scale_block_op,166,"scale_block",true)\
SIPOP(accumulate_scalar_into_block_op,167,"accumulate_scalar_into_block",true)\
SIPOP(block_add_op,168,"block_add",true)\
SIPOP(block_subtract_op,169,"block_subtract",true)\
SIPOP(block_contract_op,170,"block_contract",true)\
SIPOP(block_contract_accumulate_op,171,"block_contract_accumulate",true)\
SIPOP(block_contract_to_scalar_op,172,"block_contract_to_scalar",true)\
SIPOP(block_load_scalar_op,173,"block_load_scalar",true)\
SIPOP(slice_op,174,"slice",true)\
SIPOP(insert_op,175,"insert",true)\
SIPOP(string_load_literal_op,176,"string_load_literal",true)\
SIPOP(print_string_op,177,"print_string",true)\
SIPOP(println_op,178,"println",true)\
SIPOP(print_index_op,179,"print_index",true)\
SIPOP(print_scalar_op,180,"print_scalar",true)\
SIPOP(print_int_op,181,"print_int",true)\
SIPOP(print_block_op,182,"print_block",true)\
SIPOP(gpu_on_op,183,"gpu_on",true)\
SIPOP(gpu_off_op,184,"gpu_off",true)\
SIPOP(gpu_allocate_op,185,"gpu_allocate",true)\
SIPOP(gpu_free_op,186,"gpu_free",true)\
SIPOP(gpu_put_op,187,"gpu_put",true)\
SIPOP(gpu_get_op,188,"gpu_get",true)\
SIPOP(gpu_get_int_op,189,"gpu_get_int",true)\
SIPOP(gpu_put_int_op,190,"gpu_put_int",true)\
SIPOP(set_persistent_op,191,"set_persistent",true)\
SIPOP(restore_persistent_op,192,"restore_persistent",true)\
SIPOP(idup_op,193,"idup",true)\
SIPOP(iswap_op,194,"iswap",true)\
SIPOP(sswap_op,195,"sswap",true)\
