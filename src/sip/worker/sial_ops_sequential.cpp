...
void SialOpsSequential::set_persistent(SialxInterpreter* interpreter,
		int array_id, int string_slot) {
	persistent_array_manager_->set_persistent(interpreter, array_id, string_slot);
}

void SialOpsSequential::restore_persistent(SialxInterpreter* interpreter, int array_id, int string_slot) {
