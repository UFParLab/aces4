...
bool Fragment_Nij_aa__PardoLoopManager::increment_simple_pair(){
...
bool Fragment_Nij_aa__PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    ...
    inline bool Fragment_Nij_aa__PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_Nij_aa__PardoLoopManager::form_elst_dist() {
    ...
    void Fragment_Nij_aa__PardoLoopManager::form_rcut_dist() {
    ...
    void Fragment_Nij_aa__PardoLoopManager::form_swao_frag() {
    ...
    void Fragment_Nij_aa__PardoLoopManager::form_swocca_frag() {
    ...
    void Fragment_Nij_aa__PardoLoopManager::form_swvirta_frag() {
    ...
    inline bool Fragment_Nij_aa__PardoLoopManager::initialize_indices() {
...
/*!
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_Nij_aa__PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_Nij_aa__PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_Nij_aa__PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_Nij_aa__PardoLoopManager:  num_indices="
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_Nij_aa__PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_Nij_a_a_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_Nij_a_a_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_Nij_a_a_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_Nij_a_a_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_Nij_a_a_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_Nij_a_a_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_Nij_a_a_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_Nij_a_a_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_Nij_a_a_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*!
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_Nij_a_a_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_Nij_a_a_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_Nij_a_a_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_Nij_a_a_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_Nij_a_a_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
std::ostream& operator<<(std::ostream& os,
    ...
    bool Fragment_i_vo__PardoLoopManager::increment_simple_pair(){
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < 2; ++i) {
            more = increment_single_index(i);
    ...
    bool Fragment_i_vo__PardoLoopManager::increment_single_index(int index){
        bool more = false; 	// More iterations?
        int current_value;
        current_value = data_manager_.index_value(index_id_[index]);
        ++current_value;
    ...
    inline bool Fragment_i_vo__PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_i_vo__PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_i_vo__PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_i_vo__PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_i_vo__PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_i_vo__PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_i_vo__PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
    ...
    /*
     ...
     typ = 0: ifrag != jfrag
     */
    bool Fragment_i_vo__PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
        bool where_clause;
        int ij = 0;
        switch (typ) {
    ...
    void Fragment_i_vo__PardoLoopManager::do_finalize() {
        for (int i = 0; i < num_indices_; ++i) {
            data_manager_.set_index_undefined(index_id_[i]);
        }
    }
    
    std::string Fragment_i_vo__PardoLoopManager::to_string() const {
        std::stringstream ss;
        ss << "Fragment_i_vo__PardoLoopManager:  num_indices="
        << num_indices_ << std::endl;
        ss << "index_ids_=[";
        for (int i = 0; i < num_indices_; ++i) {
            ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
    ...
    std::ostream& operator<<(std::ostream& os,
                             const Fragment_i_vo__PardoLoopManager &obj) {
        os << obj.to_string();
        return os;
    }
    ...
    bool Fragment_i_vovo__PardoLoopManager::increment_simple_pair(){
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < 2; ++i) {
            more = increment_single_index(i);
    ...
    bool Fragment_i_vovo__PardoLoopManager::increment_single_index(int index){
        bool more = false; 	// More iterations?
        int current_value;
        current_value = data_manager_.index_value(index_id_[index]);
        ++current_value;
    ...
    inline bool Fragment_i_vovo__PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_i_vovo__PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_i_vovo__PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_i_vovo__PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_i_vovo__PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_i_vovo__PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_i_vovo__PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
    ...
    /*
     ...
     typ = 0: ifrag != jfrag
     */
    bool Fragment_i_vovo__PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
        bool where_clause;
        int ij = 0;
        switch (typ) {
    ...
    void Fragment_i_vovo__PardoLoopManager::do_finalize() {
        for (int i = 0; i < num_indices_; ++i) {
            data_manager_.set_index_undefined(index_id_[i]);
        }
    }
    
    std::string Fragment_i_vovo__PardoLoopManager::to_string() const {
        std::stringstream ss;
        ss << "Fragment_i_vovo__PardoLoopManager:  num_indices="
        << num_indices_ << std::endl;
        ss << "index_ids_=[";
        for (int i = 0; i < num_indices_; ++i) {
            ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
    ...
    std::ostream& operator<<(std::ostream& os,
                             const Fragment_i_vovo__PardoLoopManager &obj) {
        os << obj.to_string();
        return os;
    }
...
bool Fragment_ij_vo_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_ij_vo_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_ij_vo_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_ij_vo_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_ij_vo_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_ij_vo_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_ij_vo_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_ij_vo_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_ij_vo_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_ij_vo_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_ij_vo_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_ij_vo_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_ij_vo_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_ij_vo_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_Nij_vo_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_Nij_vo_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_Nij_vo_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_Nij_vo_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_Nij_vo_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_Nij_vo_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_Nij_vo_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_Nij_vo_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_Nij_vo_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_Nij_vo_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_Nij_vo_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_Nij_vo_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_Nij_vo_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_Nij_vo_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NRij_vo_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NRij_vo_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NRij_vo_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NRij_vo_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NRij_vo_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NRij_vo_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NRij_vo_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NRij_vo_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NRij_vo_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NRij_vo_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NRij_vo_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NRij_vo_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NRij_vo_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NRij_vo_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_Rij_vo_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_Rij_vo_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_Rij_vo_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_Rij_vo_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_Rij_vo_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_Rij_vo_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_Rij_vo_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_Rij_vo_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_Rij_vo_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_Rij_vo_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_Rij_vo_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_Rij_vo_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_Rij_vo_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_Rij_vo_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
    ...
    bool Fragment_i_aovo__PardoLoopManager::increment_simple_pair(){
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < 2; ++i) {
            more = increment_single_index(i);
    ...
    bool Fragment_i_aovo__PardoLoopManager::increment_single_index(int index){
        bool more = false; 	// More iterations?
        int current_value;
        current_value = data_manager_.index_value(index_id_[index]);
        ++current_value;
    ...
    inline bool Fragment_i_aovo__PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_i_aovo__PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_i_aovo__PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_i_aovo__PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_i_aovo__PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_i_aovo__PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_i_aovo__PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
    ...
    /*
     ...
     typ = 0: ifrag != jfrag
     */
    bool Fragment_i_aovo__PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
        bool where_clause;
        int ij = 0;
        switch (typ) {
    ...
    void Fragment_i_aovo__PardoLoopManager::do_finalize() {
        for (int i = 0; i < num_indices_; ++i) {
            data_manager_.set_index_undefined(index_id_[i]);
        }
    }
    
    std::string Fragment_i_aovo__PardoLoopManager::to_string() const {
        std::stringstream ss;
        ss << "Fragment_i_aovo__PardoLoopManager:  num_indices="
        << num_indices_ << std::endl;
        ss << "index_ids_=[";
        for (int i = 0; i < num_indices_; ++i) {
            ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
    ...
    std::ostream& operator<<(std::ostream& os,
                             const Fragment_i_aovo__PardoLoopManager &obj) {
        os << obj.to_string();
        return os;
    }
    ...
    bool Fragment_i_aaaa__PardoLoopManager::increment_simple_pair(){
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < 2; ++i) {
            more = increment_single_index(i);
    ...
    bool Fragment_i_aaaa__PardoLoopManager::increment_single_index(int index){
        bool more = false; 	// More iterations?
        int current_value;
        current_value = data_manager_.index_value(index_id_[index]);
        ++current_value;
    ...
    inline bool Fragment_i_aaaa__PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_i_aaaa__PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_i_aaaa__PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_i_aaaa__PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_i_aaaa__PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_i_aaaa__PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_i_aaaa__PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
    ...
    /*
     ...
     typ = 0: ifrag != jfrag
     */
    bool Fragment_i_aaaa__PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
        bool where_clause;
        int ij = 0;
        switch (typ) {
    ...
    void Fragment_i_aaaa__PardoLoopManager::do_finalize() {
        for (int i = 0; i < num_indices_; ++i) {
            data_manager_.set_index_undefined(index_id_[i]);
        }
    }
    
    std::string Fragment_i_aaaa__PardoLoopManager::to_string() const {
        std::stringstream ss;
        ss << "Fragment_i_aaaa__PardoLoopManager:  num_indices="
        << num_indices_ << std::endl;
        ss << "index_ids_=[";
        for (int i = 0; i < num_indices_; ++i) {
            ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
    ...
    std::ostream& operator<<(std::ostream& os,
                             const Fragment_i_aaaa__PardoLoopManager &obj) {
        os << obj.to_string();
        return os;
    }
    ...
    bool Fragment_i_aoo__PardoLoopManager::increment_simple_pair(){
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < 2; ++i) {
            more = increment_single_index(i);
    ...
    bool Fragment_i_aoo__PardoLoopManager::increment_single_index(int index){
        bool more = false; 	// More iterations?
        int current_value;
        current_value = data_manager_.index_value(index_id_[index]);
        ++current_value;
    ...
    inline bool Fragment_i_aoo__PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_i_aoo__PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_i_aoo__PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_i_aoo__PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_i_aoo__PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_i_aoo__PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_i_aoo__PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
    ...
    /*
     ...
     typ = 0: ifrag != jfrag
     */
    bool Fragment_i_aoo__PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
        bool where_clause;
        int ij = 0;
        switch (typ) {
    ...
    void Fragment_i_aoo__PardoLoopManager::do_finalize() {
        for (int i = 0; i < num_indices_; ++i) {
            data_manager_.set_index_undefined(index_id_[i]);
        }
    }
    
    std::string Fragment_i_aoo__PardoLoopManager::to_string() const {
        std::stringstream ss;
        ss << "Fragment_i_aoo__PardoLoopManager:  num_indices="
        << num_indices_ << std::endl;
        ss << "index_ids_=[";
        for (int i = 0; i < num_indices_; ++i) {
            ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
    ...
    std::ostream& operator<<(std::ostream& os,
                             const Fragment_i_aoo__PardoLoopManager &obj) {
        os << obj.to_string();
        return os;
    }
...
bool Fragment_NRij_vovo__PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NRij_vovo__PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NRij_vovo__PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NRij_vovo__PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NRij_vovo__PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NRij_vovo__PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NRij_vovo__PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NRij_vovo__PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NRij_vovo__PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NRij_vovo__PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NRij_vovo__PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NRij_vovo__PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NRij_vovo__PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NRij_vovo__PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NRij_ao_ao_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NRij_ao_ao_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NRij_ao_ao_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NRij_ao_ao_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NRij_ao_ao_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NRij_ao_ao_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NRij_ao_ao_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NRij_ao_ao_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NRij_ao_ao_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NRij_ao_ao_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NRij_ao_ao_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NRij_ao_ao_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NRij_ao_ao_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NRij_ao_ao_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NRij_vo_ao_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NRij_vo_ao_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NRij_vo_ao_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NRij_vo_ao_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NRij_vo_ao_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NRij_vo_ao_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NRij_vo_ao_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NRij_vo_ao_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NRij_vo_ao_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NRij_vo_ao_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NRij_vo_ao_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NRij_vo_ao_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NRij_vo_ao_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NRij_vo_ao_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NRij_aa_aa_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NRij_aa_aa_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NRij_aa_aa_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NRij_aa_aa_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NRij_aa_aa_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NRij_aa_aa_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NRij_aa_aa_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NRij_aa_aa_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NRij_aa_aa_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NRij_aa_aa_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NRij_aa_aa_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NRij_aa_aa_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NRij_aa_aa_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NRij_aa_aa_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NRij_vv_oo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NRij_vv_oo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NRij_vv_oo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NRij_vv_oo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NRij_vv_oo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NRij_vv_oo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NRij_vv_oo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NRij_vv_oo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NRij_vv_oo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NRij_vv_oo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NRij_vv_oo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NRij_vv_oo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NRij_vv_oo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NRij_vv_oo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NRij_o_ao_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NRij_o_ao_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NRij_o_ao_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NRij_o_ao_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NRij_o_ao_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NRij_o_ao_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NRij_o_ao_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NRij_o_ao_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NRij_o_ao_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NRij_o_ao_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NRij_o_ao_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NRij_o_ao_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NRij_o_ao_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NRij_o_ao_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_ij_aa_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_ij_aa_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_ij_aa_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_ij_aa_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_ij_aa_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_ij_aa_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_ij_aa_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_ij_aa_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_ij_aa_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_ij_aa_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_ij_aa_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_ij_aa_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_ij_aa_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_ij_aa_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_ij_av_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_ij_av_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_ij_av_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_ij_av_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_ij_av_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_ij_av_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_ij_av_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_ij_av_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_ij_av_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_ij_av_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_ij_av_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_ij_av_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_ij_av_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_ij_av_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NR1ij_vo_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NR1ij_vo_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NR1ij_vo_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NR1ij_vo_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NR1ij_vo_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NR1ij_vo_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NR1ij_vo_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NR1ij_vo_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NR1ij_vo_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NR1ij_vo_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NR1ij_vo_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NR1ij_vo_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NR1ij_vo_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NR1ij_vo_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NR1ij_oo_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NR1ij_oo_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NR1ij_oo_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NR1ij_oo_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NR1ij_oo_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NR1ij_oo_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NR1ij_oo_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NR1ij_oo_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NR1ij_oo_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NR1ij_oo_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NR1ij_oo_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NR1ij_oo_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NR1ij_oo_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NR1ij_oo_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
...
bool Fragment_NR1ij_vv_vo_PardoLoopManager::increment_simple_pair(){
    bool more = false;      // More iterations?
    int current_value;
    for (int i = 0; i < 2; ++i) {
        more = increment_single_index(i);
...
bool Fragment_NR1ij_vv_vo_PardoLoopManager::increment_single_index(int index){
    bool more = false; 	// More iterations?
    int current_value;
    current_value = data_manager_.index_value(index_id_[index]);
    ++current_value;
    ...
    inline bool Fragment_NR1ij_vv_vo_PardoLoopManager::increment_all() {
        bool more = false;      // More iterations?
        int current_value;
        for (int i = 0; i < num_indices_; ++i) {
            more = increment_single_index(i);
    ...
    void Fragment_NR1ij_vv_vo_PardoLoopManager::form_elst_dist() {
        int elst_dist_array_slot = sip_tables_.array_slot(std::string("elst_dist"));
        Block::BlockPtr bptr_elst_dist = data_manager_.contiguous_array_manager().get_array(elst_dist_array_slot);
        double *val_elst_dist = bptr_elst_dist->get_data();
        int elst_dist_size = bptr_elst_dist->size();
    ...
    void Fragment_NR1ij_vv_vo_PardoLoopManager::form_rcut_dist() {
        int rcut_dist_array_slot = sip_tables_.array_slot(std::string("rcut_dist"));
        Block::BlockPtr bptr_rcut_dist = data_manager_.contiguous_array_manager().get_array(rcut_dist_array_slot);
        double *val_rcut_dist = bptr_rcut_dist->get_data();
        int rcut_dist_size = bptr_rcut_dist->size();
    ...
    void Fragment_NR1ij_vv_vo_PardoLoopManager::form_swao_frag() {
        int swao_frag_array_slot = sip_tables_.array_slot(std::string("swao_frag"));
        Block::BlockPtr bptr_swao_frag = data_manager_.contiguous_array_manager().get_array(swao_frag_array_slot);
        double *val_swao_frag = bptr_swao_frag->get_data();
        int swao_frag_size = bptr_swao_frag->size();
    ...
    void Fragment_NR1ij_vv_vo_PardoLoopManager::form_swocca_frag() {
        int swocca_frag_array_slot = sip_tables_.array_slot(std::string("swocca_frag"));
        Block::BlockPtr bptr_swocca_frag = data_manager_.contiguous_array_manager().get_array(swocca_frag_array_slot);
        double *val_swocca_frag = bptr_swocca_frag->get_data();
        int swocca_frag_size = bptr_swocca_frag->size();
    ...
    void Fragment_NR1ij_vv_vo_PardoLoopManager::form_swvirta_frag() {
        int swvirta_frag_array_slot = sip_tables_.array_slot(std::string("swvirta_frag"));
        Block::BlockPtr bptr_swvirta_frag = data_manager_.contiguous_array_manager().get_array(swvirta_frag_array_slot);
        double *val_swvirta_frag = bptr_swvirta_frag->get_data();
        int swvirta_frag_size = bptr_swvirta_frag->size();
    ...
    inline bool Fragment_NR1ij_vv_vo_PardoLoopManager::initialize_indices() {
        //initialize values of all indices
        bool more_iterations = true;
        for (int i = 0; i < num_indices_; ++i) {
            if (lower_seg_[i] >= upper_bound_[i]) {
...
/*
 ...
 typ = 0: ifrag != jfrag
 */
bool Fragment_NR1ij_vv_vo_PardoLoopManager::fragment_special_where_clause(int typ, int index, int frag) {
    bool where_clause;
    int ij = 0;
    switch (typ) {
...
void Fragment_NR1ij_vv_vo_PardoLoopManager::do_finalize() {
    for (int i = 0; i < num_indices_; ++i) {
        data_manager_.set_index_undefined(index_id_[i]);
    }
}

std::string Fragment_NR1ij_vv_vo_PardoLoopManager::to_string() const {
    std::stringstream ss;
    ss << "Fragment_NR1ij_vv_vo_PardoLoopManager:  num_indices="
    << num_indices_ << std::endl;
    ss << "index_ids_=[";
    for (int i = 0; i < num_indices_; ++i) {
        ss << (i == 0 ? "" : ",") << sip_tables_.index_name(index_id_[i]);
...
std::ostream& operator<<(std::ostream& os,
                         const Fragment_NR1ij_vv_vo_PardoLoopManager &obj) {
    os << obj.to_string();
    return os;
}
